...
// Please note when the routines are running the timing is critcal for the LED's
// so limit Web Access for the more Complex routines.
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//!!!!!!!!!!!!! WARNING !!!! these sequences may trigger Photosensative Epilepsy !!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
There are other remnants I have left in to allow expansion.....
...
SDK Functionality
/srestart
Reset the ESP8266 Module remotely, the module MUST be cold booted for this to function.
...
int wloop=5;
char tDigit; 
String TiMeS,MyNtP;                            // The current TimeStamp from Google....
...
void setup() {
// Un comment the next line for connection to your home network
//  WiFi.mode(WIFI_AP_STA);
// Only use the line above OR the line below.....
WiFi.mode(WIFI_AP);
  WiFi.softAPConfig(apIP, apIP, IPAddress(255, 255, 255, 0));
  WiFi.softAP("EM-Pixels http://192.168.4.1");    // Create Open WiFi network, use which ever you like...
//  WiFi.softAP("EM-Pixels http://192.168.4.1", "987654321");    // Create Secure WiFi network 
...
animate = true;
 ...
 if(sPath=="/")
     ...
     ulReqcount++;
                              ...
                              //  diagdat+=ulReconncount;
                               ...
                               // diagdat+=ulMeasCount;
                                ...
                                client.println("<IMG SRC=\"http://192.168.1.14:82/images/esp-201.jpg\" WIDTH=\"370\" HEIGHT=\"240\" BORDER=\"1\"></body></html>");
                                diagdat = "";
                                duration1 = "";
  }
   else if(sPath=="/srestart")
  {
                                ...
                                client.print("<FONT SIZE=-2>Compiled Using ver. 1.6.5-1160-gef26c5f, built on Sep 30, 2015<BR>");
                                client.println("<IMG SRC=\"http://192.168.1.14:82/images/esp-201.jpg\" WIDTH=\"250\" HEIGHT=\"151\" BORDER=\"1\"></body></html>");


//    This is a file Hosted by an ESP8266-201 SD Webserver, also used as Gateway for Sensor Portal........
//    http://192.168.1.14:82/images/esp-201.jpg
client.stop();
wsysreset();
  }
  else 
